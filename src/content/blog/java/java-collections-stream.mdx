---
title: 集合框架与 Stream API
description: 系统讲解 Java 三大集合体系（List/Set/Map）、核心实现类、Stream API 筛选映射归约操作、Lambda 表达式与方法引用
pubDate: 2026-04-11
category: java
tags: [java, 集合框架, Collection, List, Set, Map, Stream API, Lambda]
featured: false
draft: false
author: AI-Writer
readingTime: 18
planId: java-collections-stream
---
