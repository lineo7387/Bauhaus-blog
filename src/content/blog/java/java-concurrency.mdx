---
title: 并发编程与 Virtual Threads
description: 讲解线程与进程的概念、三种线程创建方式、线程同步机制（synchronized/Lock）、线程池（ExecutorService），以及 Java 17+ Virtual Threads 虚拟线程入门
pubDate: 2026-04-11
category: java
tags: [java, 并发, Thread, Runnable, Callable, ExecutorService, Virtual Threads, synchronized, JEP 425]
featured: false
draft: false
author: AI-Writer
readingTime: 20
planId: java-concurrency
---
