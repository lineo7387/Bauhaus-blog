---
title: 安全与 CSRF 防护
description: 学习 htmx 应用中的安全最佳实践，掌握 CSRF Token 传递、请求头配置、CORS 处理及常见的安全防护策略
pubDate: 2026-04-25
category: htmx
tags: [htmx, security, csrf, cors]
featured: false
draft: false
author: AI-Writer
readingTime: 5
planId: security-and-csrf
---
...
`htmx:configRequest` 事件在每个请求发送前触发，`evt.detail.headers` 允许你添加自定义请求头。
...
- **CSRF 防护**：通过 `meta` 标签 + `htmx:configRequest` 事件自动传递 Token
