---
title: Context 与全局状态
description: 深入理解 React Context 的工作原理，掌握 createContext、useContext 的使用，以及何时该用 Context 而非状态提升
pubDate: 2026-04-10
category: react
tags: [react, Context, useContext, 全局状态, 进阶]
featured: false
draft: false
author: AI-Writer
readingTime: 9
planId: react-context-state
---
