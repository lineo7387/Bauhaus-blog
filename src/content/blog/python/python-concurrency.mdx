---
title: 并发与并行编程
description: 详解 Python 的 threading 多线程、multiprocessing 多进程、GIL 原理、concurrent.futures 与进程池/线程池的使用
pubDate: 2026-04-10
category: python
tags: [python, 并发, 并行, threading, multiprocessing, GIL]
featured: false
draft: false
author: AI-Writer
readingTime: 9
planId: python-concurrency
---
