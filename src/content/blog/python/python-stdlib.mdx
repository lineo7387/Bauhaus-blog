---
title: 常用标准库详解
description: 深入讲解 datetime 日期时间、collections 容器、functools 高阶函数、itertools 与 contextlib 等常用标准库的实用技巧
pubDate: 2026-04-10
category: python
tags: [python, 标准库, datetime, collections, functools, itertools]
featured: false
draft: false
author: AI-Writer
readingTime: 7
planId: python-stdlib
---
